...
export const About = ({ summary }: { summary: string }) => (
  <Section section="about">
    ...
    <p className={styles.textBlock}>
      ...
      <a href="https://elastic.co">Elastic</a>, working from my home in Kansas
      City, MO.
    </p>
    <p className={styles.lastTextBlock}>
      In the past, I&apos;ve worked for Facebook, Cerner, Sprint and Accenture,
      and lived in New York, Vancouver and San Francisco. So far we&apos;ve
      visited 40 countries, (and counting).
    </p>
