  ...
  return (
    <section className={styles.root}>
      <header className={styles.heading}>
        <h3 className={styles.title}>About My Work Experience</h3>
      </header>
          ...
          <div className={styles.block}>
            ...
            <div className={styles.desc}>
              <p>
                ...
                When I first moved out to the Big Apple, I did a hack-a-quarter
                on the Composer, and then worked on the Share Dialog.
              </p>
              <p>
                Eventually Events found themselves with a large number of React
                and Relay projects, so I rejoined my former team remotely. I've
                been with them ever since, building the new Events Dashboard,
                Permalink, as well as other "under the hood" improvements.
              </p>
            </div>
          </div>
          <div className={styles.block}>
            ...
            <div className={styles.desc}>
              <p>
                ...
                made sense for me to bring Facebook experience (and culture) to
                a group of "n00bs".
              </p>
              <p>
                While there, I worked on the Protect and Care team developing a
                new Messaging Inbox built in React. I also implemented the Open
                Graph Share dialog for FB Platform in XHP.
              </p>
            </div>
          </div>
          <div className={styles.block}>
            ...
            <div className={styles.desc}>
              <p>
                I joined Facebook in 2012 as a User Interface Engineer (UIE) on
                the Mobile Core Web team. I worked on a number of reusable
                components in XHP. I then joined the Accessibility team to help
                make Facebook more useful to everyone on the web.
              </p>
              <p>
                After several hackathons involving Events, I joined the team
                full time to rewrite the web experiences on both the mobile and
                main website.
              </p>
              <p>
        ...
        <div className={styles.timeline}>
          <div className={styles.block}>
            ...
            <div className={styles.desc}>
              <p>
                ...
                semantics, accessibility, web agnostics and the responsible use
                of CSS and JavaScript.
              </p>
              <p>
                I was incredibly fortunate to have some time to do a lot of
                research into newer web technologies for appropriateness in the
                ecosystem, (e.g. mobile portability, PhoneGap, Node). I hacked
                on a lot of prototypes...!
              </p>
            </div>
          </div>
          <div className={styles.block}>
            ...
            <div className={styles.desc}>
              <p>
                As a Software Architect I was responsible for rapid prototyping
                of HTML code based on intricate visual designs. I would then
                deliver these to clients, stakeholders, usability researchers
                and, eventually, engineers.
              </p>
              <p>
          ...
          <div className={styles.block}>
            ...
            <div className={styles.header}>
              ...
              <h4 className={styles.itemTitle}>Cerner Corporation</h4>
              <h5 className={styles.itemSubtitle}>Senior Software Engineer</h5>
            </div>
            <div className={styles.desc}>
              <p>
                As a Sr. Software Engineer, I served as the "Presentation-layer
                Architect" over the ePrescribing (eRx) and Community Health
                Record (CHR) solutions for the treatment of entire Medicare
